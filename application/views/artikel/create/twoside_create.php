  ...
  <form method="post" action="" enctype="multipart/form-data">
    ...
    <section id="main-element" class="mb-32 mt-2">
      <div class="mx-auto text-center mb-4">
        <input required class="relative w-full md:w-[80%] px-4 outline-blue-500 py-2 left-0 right-0 mx-auto border text-center text-2xl font-semibold rounded-lg" type="text" name="artikel-title" id="artikel-title" placeholder="Judul Artikel Anda" value="<?= set_value('artikel-title')?>">
    ...
    <!--Element 1-->
      <div id="element-1" class="mb-16 flex flex-wrap">
        ...
        <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
          ...
          <!-- Deskripsi -->
          <div class="mb-3">
            <textarea required name="artikel-deskripsi-1" id="artikel-deskripsi-1" cols="30" rows="10" placeholder="Deskripsi Artikel Anda.." class="relative w-full px-1 outline-blue-500 py-1 border text-left pl-3 text-md font-semibold rounded-lg"></textarea>
          </div>
        </div>
      ...
      <!-- Element 2 -->
      <div id="element-2" class="mb-16 flex flex-wrap lg:flex-row-reverse">
          <div class="mb-6 w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-6/12 lg:pr-6">
            <div class="relative">
                <div class="ripple mb-2 relative overflow-hidden rounded-lg border h-96 bg-cover bg-[50%] bg-no-repeat shadow-lg dark:shadow-black/20">
                    <img id="preview-image-2" src="#" alt="Preview Gambar" class="hidden w-full h-full">
                    <div id="text-2" class="absolute w-full text-center mt-40 font-semibold text-gray-400/70 text-2xl h-full">
                            <h2>Silahkan Memilih Gambar</h2> <span class="text-sm font-normal">Maximal 5Mb</span>
                    </div>
                    <div class="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-[hsl(0,0%,98.4%,0.2)] bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100"></div>
                </div>
                <div class="z-50 mx-auto">
                    <input type="file" accept=".jpeg, .jpg, .png" required name="Image-2" class="hidden" id="Image-2" onchange="previewImage(2)">
                    <label class="bg-transparent  md:absolute right-0 hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-1 px-2 border border-blue-500 hover:border-transparent rounded" for="Image-2">Pilih Gambar</label>
                </div>
              </div>
          </div>
        ...
        <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pr-6">
          <div class="mb-4">
            <input required class="relative w-full md:w-[80%] px-1 outline-blue-500 py-1 border text-left pl-3 text-lg font-semibold rounded-lg" type="text" name="image-title-2" id="image-title-2" placeholder="Judul Gambar" value="<?= set_value('image-title-2')?>">
            <?php echo form_error('image-title-2', '<h1 class="absolute ml-10 bg-black text-md mt-20"><font class="text-blue-100 mt-20"></font></h1>'); ?>
          </div>
          <div class="mb-3">
          <textarea required name="artikel-deskripsi-2" id="artikel-deskripsi-2" cols="30" rows="10"></textarea>
          </div>
        </div>
      </div>
      ...
      <!-- Element 3 -->
      <div id="element-3" class="flex flex-wrap">
        <div class="mb-6 w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-6/12 lg:pr-6">
            <div class="relative">
              <div class="ripple mb-2 relative overflow-hidden rounded-lg border h-96 bg-cover bg-[50%] bg-no-repeat shadow-lg dark:shadow-black/20">
                 <img id="preview-image-3" src="#" alt="Preview Gambar" class="hidden w-full h-full">
              ...
              <div class="z-50 mx-auto">
                  <input type="file" accept=".jpeg, .jpg, .png" required name="Image-3" class="hidden" id="Image-3" onchange="previewImage(3)">
        ...
        <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
          <div class="mb-4">
            <input required class="relative w-full md:w-[80%] px-1 outline-blue-500 py-1 border text-left pl-3 text-lg font-semibold rounded-lg" type="text" name="image-title-3" id="image-title-3" placeholder="Judul Gambar" value="<?= set_value('image-title-3')?>">
            <?php echo form_error('image-title-3', '<h1 class="absolute ml-10 bg-black text-md mt-20"><font class="text-blue-100 mt-20"></font></h1>'); ?>
          </div>
          <div class="mb-3">
            <textarea required name="artikel-deskripsi-3" id="artikel-deskripsi-3" cols="30" rows="10"></textarea>
          </div>
        </div>
