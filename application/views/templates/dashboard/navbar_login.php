...
<body >
<header id="head" class="dark:bg-slate-800 fixed w-full bg-transparent transition-all duration-1000 w-full z-50 dark:text-slate-100 shadow-sm ">
  <div class="w-full hidden md:block mx-auto px-20">
    <nav class="flex items-center justify-between py-4">
      ...
      <div class="flex items-center font-semibold gap-4">
        ...
        <div class="bg-transparent border border-blue-500 hover:bg-[#3C2A80] cursor-pointer hover:text-white text-gray-800 px-4 py-1 transition-all duration-700 rounded-full text-center">
    ...
    <div id="sub-menu" class="w-1/2 z-50 h-auto dark:bg-slate-800 dark:text-slate-100 text-center md:hidden py-4 px-4 font-semibold text-md shadow-md shadow-gray-600 rounded-b-md transition-all duration-700 border bg-white border-t-blue-500 fixed -right-96 ">
      <div class="group mb-4 text-center">
       ...
       <div class="group mb-4 text-center">
        ...
        <!-- <div class="group mb-4 rounded-full px-2 py-2 hover:bg-gray-500 text-center mx-auto w-9 h-9 mt-3">
          <a href="#"><svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 384 512"><path d="M223.5 32C100 32 0 132.3 0 256S100 480 223.5 480c60.6 0 115.5-24.2 155.8-63.4c5-4.9 6.3-12.5 3.1-18.7s-10.1-9.7-17-8.5c-9.8 1.7-19.8 2.6-30.1 2.6c-96.9 0-175.5-78.8-175.5-176c0-65.8 36-123.1 89.3-153.3c6.1-3.5 9.2-10.5 7.7-17.3s-7.3-11.9-14.3-12.5c-6.3-.5-12.6-.8-19-.8z"/></svg></a>
        </div> -->
